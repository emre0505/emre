...
module.exports.execute = async (client, message, args, ayar, emoji) => {
    ...
    let embed = new MessageEmbed().setThumbnail(user.user.avatarURL({dynamic: true, size: 2048})).setAuthor(user.displayName, user.user.avatarURL({dynamic: true, size: 2048})).setColor(client.randomColor()).setTimestamp();
